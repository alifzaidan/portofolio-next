    ...
    return (
        <section className="container h-full flex flex-col justify-center">
            <div className="flex gap-4 text-xl border-b border-black pb-4">
                <h6 className="font-acumin">Based in Malang, Indonesia</h6>
                <HiOutlineArrowLongRight />
                <h6 className="font-acumin font-bold">{currentTime}</h6>
            </div>
            <h1 className="text-8xl font-degular font-medium mt-12 mb-28">Hi, this is Alif.</h1>
            <ul className="space-y-2">
                <li className="flex gap-4 text-xl">
                    <h6 className="font-acumin">Currently</h6>
                    <HiOutlineArrowLongRight />
                    <h6 className="font-acumin font-bold">
                ...
                <li className="flex gap-4 text-xl">
                    <h6 className="font-acumin">Passionate</h6>
                    <HiOutlineArrowLongRight />
                    <h6 className="font-acumin font-bold">Developing Cutting-edge Interfaces</h6>
                </li>
                <li className="flex gap-4 text-xl">
                    <h6 className="font-acumin">Delivering</h6>
                    <HiOutlineArrowLongRight />
                    <h6 className="font-acumin font-bold">Smiles ☻</h6>
                </li>
            </ul>
        </section>
    );
