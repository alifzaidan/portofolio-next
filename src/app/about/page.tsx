        ...
        <main className="bg-secondary">
            ...
            >
                ...
                <div className="relative z-10">
                    <h1 className="font-degular md:text-6xl text-5xl font-medium md:mb-12 mb-8">
                        Hello, I am Muchammad Alif Zaidan
                    </h1>
                    <div className="md:text-xl md:space-y-8 space-y-4">
                        <p>
                            A fullstack web developer pursuing a passion for
                            creating engaging and innovative web experiences ☻
                        </p>
                        <p>
                            I graduated from Informatics Engineering at UIN
                            Maulana Malik Ibrahim Malang. Currently, I work as a
                            fullstack developer at CV. Aksara Teknologi Mandiri
                            and as a freelance frontend developer at PT. Ekata
                            Technology Indonesia. I am also active in the tech
                            community as a former lead of Google Developer
                            Student Clubs Maliki.
                        </p>
                        <p>
                            My adventure in technology began during my time in
                            college, and I&apos;m always eager to connect and
                            share experiences. Feel free to reach out via
                            contact page and my social media.
                        </p>
                    </div>
                </div>
                <hr className="border-black md:my-16 my-10 relative z-10" />
                <h2 className="font-degular md:text-4xl text-3xl font-medium md:mb-12 mb-8 relative z-10">
                    Work and Community Experience
                </h2>
                <div className="md:space-y-8 space-y-6 relative z-10">
                    <div className="md:flex justify-between items-center">
                        <div className="space-y-2">
                            <h4 className="md:text-3xl text-2xl font-degular font-medium">
                                Fullstack Web Developer
                            </h4>
                            <p className="md:text-xl">
                                CV. Aksara Teknologi Mandiri
                            </p>
                        </div>
                        <p className="md:text-xl">January 2025 - Present</p>
                    </div>
                    <div className="md:flex justify-between items-center">
                        <div className="space-y-2">
                            <h4 className="md:text-3xl text-2xl font-degular font-medium">
                    ...
                    <div className="md:flex justify-between items-center">
                        <div className="space-y-2">
                            <h4 className="md:text-3xl text-2xl font-degular font-medium">
                                Internship as Information Technology Engineer
                            </h4>
                            <p className="md:text-xl">
                    ...
                    <div className="md:flex justify-between items-center">
                        <div className="space-y-2">
                            ...
                            <p className="md:text-xl">
                                Google Developer Student Clubs Maliki
                            </p>
                        </div>
                ...
                <hr className="border-black md:my-16 my-10 relative z-10" />
                <h2 className="font-degular text-4xl font-medium mb-12 relative z-10">
                    Tech Stack
                </h2>
